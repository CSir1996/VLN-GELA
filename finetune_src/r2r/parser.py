...
def postprocess_args(args):
    ...
    args.img_ft_file = os.path.join(ROOTDIR, 'R2R', 'envedit_features', ft_file_map[args.features])
    if args.features_aug:
        args.img_aug_ft_file = os.path.join(ROOTDIR, 'R2R', 'envedit_features', ft_file_map[args.features_aug])
    else:
